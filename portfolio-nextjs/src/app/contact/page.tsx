                  ...
                  <Card className="p-8 bg-gradient-hero text-white h-full">
                    ...
                    <div className="space-y-6">
                      <a
                        ...
                        className="flex items-start gap-4 text-[var(--color-neutral-200)] hover:text-[var(--color-accent-400)] transition-colors"
                      >
                      ...
                      <div className="flex items-start gap-4 text-[var(--color-neutral-200)]">
                        <div className="w-12 h-12 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
